...
{
	if($code=="PP" && $title !="Problem Solving for Programming")
	{
		return false;
	}
	elseif($code="P1" && $title !="Web Programming using PHP")
	{
		return false;
	}
	elseif($code="DT" && $title !=" Introduction to Database Technology")
	{
		return false;
	}
...
function moduleCodeValid($code, $title)
{
	...
	{
		return "Incorrect char code";
	}
	elseif(!ctype_digit($yr))
	{
		return "Incorrect academic year";
	}
	elseif(!in_array($term_code,$valid_term_codes))
	{
		return "Incorrect term code";
	}
	elseif(!codeAndTitleMatch($code,$title))
	{
		return "Code and title do not match";
	}
...
#Parameters: String $text - text to be checked for validitiy
...
#Parameters: String $date - date to be checked for validitiy
#Return: Boolean True or False 
function dateValid($date)
{
	...
	if(count($date)!=3) #checking if explode not sucessful 
	{
		return false;
	}
...
#Parameters: String $id - id to be checked for validitiy
#Return: Boolean True or False 
